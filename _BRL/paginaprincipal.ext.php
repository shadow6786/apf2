<?php
require_once("paginaprincipal.class.php");

class cpaginaprincipal_ext extends cpaginaprincipal
{
	...
	public function obtener_contenidoprincipal()
    {
       try
	   {
		/*
		...
		*/
		...
		$sql = "SELECT * FROM smc_paginaprincipal where id_ppl = 1";
   		$rs = mysql_query($sql);
		$total_filas = mysql_num_rows($rs);
