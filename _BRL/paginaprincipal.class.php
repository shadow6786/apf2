...
class cpaginaprincipal
{
	...
	public function borrar()
	{
  		 try
		 {
			$sql = "DELETE FROM smc_paginaprincipal WHERE id_ppl=" . mysql_real_escape_string($this->id_ppl);
  			mysql_query($sql);
			if (mysql_errno()) 
			{ 
	...
	public function insertar()	
	{
		try
		 {
			$sql = "INSERT INTO smc_paginaprincipal SET
	...
	public function actualizar()
	{
		try
		{
  			$sql = "UPDATE smc_paginaprincipal SET
	...
	public function ObtenerUnRegistro()
  	{
    	try
		{
  			$sql = 'SELECT * FROM smc_paginaprincipal WHERE id_ppl=\'' . mysql_real_escape_string($this->id_ppl)."'";
	...
	public function BorrarPorFiltro()
	{
	  	 ...
	  	 try
		 {
			$sql = "DELETE FROM smc_paginaprincipal ";
    ...
    public function buscar($pag,$todos = 'N')
    {
       try
	   {
		    $sql = "SELECT * FROM smc_paginaprincipal";
        	$sql_total = "SELECT count(*) as cantidad_filas FROM smc_paginaprincipal"; 
			$sql_filtrado = "";
			$where = array();
